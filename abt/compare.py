...
def run_comparison(abts: List[ABTProfile], use_llm: bool = True,
    ...
    if use_llm:
        ...
        # synthesise_drift_insights_v2 uses 3 focused LLM calls with actual
        # computed numbers. Falls back to v1 single-call on any failure.
        try:
            from .llm_drift_narratives import synthesise_drift_insights_v2
            ...
            try:
                from .llm_drift_narratives import collect_all_signals, _fallback
                from .llm_drift_narratives import DOMAIN_LABELS, PURPOSE_LABELS
